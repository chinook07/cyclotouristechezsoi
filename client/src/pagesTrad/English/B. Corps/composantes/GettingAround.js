...
const GettingAround = () => {
    return (
        <section>
            ...
            <p>When travelling by intercity train <ExternalLink href="https://www.viarail.ca/en/travel-info/baggage/non-standard-items" target="blank">(VIA Rail)</ExternalLink>, only those offering checked baggage service enable you to bring your bicycle, normally unpacked, for a $25 fee. In the Montréal area, Exo provides <ExternalLink href="https://exo.quebec/en/trip-planner/bike/riding-public-transit" target="blank">regional commuter service</ExternalLink> allowing bikes on board all trains.</p>
