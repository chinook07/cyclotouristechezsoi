...
const GettingIn = () => {
    ...
    return (
        <section>
            ...
            <p>Other options for flying into Quebec include the international airports in Ottawa (close to Gatineau) and Quebec City, both around {mesuresMetriques ? <span>15 km</span> : <span>10 miles</span>} from their respective city centres. There are various regional airports located throughout the province but they are only served by several flights a day.</p>
