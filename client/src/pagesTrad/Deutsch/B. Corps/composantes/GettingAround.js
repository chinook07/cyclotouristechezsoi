...
const GettingAround = () => {
    return (
        <section>
            ...
            <p>Wenn Sie mit einem Intercity-Zug <ExternalLink href="https://www.viarail.ca/en/travel-info/baggage/non-standard-items" target="blank">(VIA Rail)</ExternalLink> reisen, können Sie nur bei Zügen mit aufgegebenem Gepäck Ihr Fahrrad, das normalerweise unverpackt ist, gegen eine Gebühr von $25 mitnehmen. Leider sind die Corridor-Züge (tägliche Abfahrten zwischen Quebec und Windsor) ausgeschlossen, aber Fahrradmitnahme aus den maritimen Provinzen oder dem Norden Quebecs ist möglich. In der Gegend von Montreal bietet Exo einen <ExternalLink href="https://exo.quebec/en/trip-planner/bike/riding-public-transit" target="blank">S-bahn</ExternalLink> an, der es erlaubt, Fahrräder an Bord aller Abfahrten zu nehmen.</p>
