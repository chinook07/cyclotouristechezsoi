...
import { faFaceGrin, faBed, faTruck, faFeather, faTrain } from "@fortawesome/free-solid-svg-icons";
...
const Age1 = () => {
    return (
        <Wrapper>
            ...
            <ul>
                <li>
                    <h4>Siège avant + chariot <FontAwesomeIcon icon={faFaceGrin}/> <FontAwesomeIcon icon={faBed}/> <FontAwesomeIcon icon={faTruck}/></h4>
                ...
                <li>
                    <h4>Siège avant + arrière <FontAwesomeIcon icon={faFaceGrin}/></h4>
