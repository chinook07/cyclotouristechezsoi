    ...
    return (
        <div>
            ...
            <section>
                ...
                <p>Il est possible de transporter une bicyclette sur tous les trains ayant un fourgon à bagages, sans devoir la démonter. Cela s'applique pour aller vers Saguenay, l'Abitibi et les Maritimes. À noter que ces trains circulent trois fois par semaine seulement. <strong>Le service d'enregistrement des vélos sur les lignes Québec–Windsor, aboli en 2020, <ExternalLink href="https://media.viarail.ca/fr/communiques/2026/rail-reintroduit-transport-velos-bord-corridor-ottawa-quebec">a enfin commencé à reprendre en mai 2026</ExternalLink>. Deux départs par jour entre Québec et Ottawa (mais seulement un départ la fin de semaine en direction d'Ottawa) peut maintenant transporter jusqu'à un maximum de quatre vélos.</strong> Attention : la moitié des places sont seulement offertes aux passagers en classe affaires. Vous trouvez cela inacceptable? <ExternalLink href="https://www.viarail.ca/fr/nous-joindre/formulaire?topic=comment">Laissez-les savoir ici</ExternalLink>!</p>
                ...
                <p>Avant de réserver votre billet, relisez <ExternalLink href="https://www.viarail.ca/fr/planifier/bagages/equipements-sport">toute l'information de VIA Rail</ExternalLink>! Cela vous évitera de mauvaises surprises. À noter que le transport de vélos n'est pas possible sur la portion québécoise de la ligne d'Amtrak de Montréal à New York (l'Adirondack). <strong>Nouveau :</strong> Il est maintenant possible d'embarquer à Rouses Point, situé à 85 km de la station REM du Quartier, ou à 50 km de la gare de Candiac. L'autre option est de prendre <ExternalLink href="https://francais.amtrak.com/onboard/bring-your-bicycle-onboard/bikes-on-the-vermonter-train.html">le Vermonter ou l'Ethan Allen Express</ExternalLink>, à partir du nord du Vermont.</p>
            </section>
            <section>
