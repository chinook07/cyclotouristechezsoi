    ...
    return (
        <div>
            ...
            <section>
                ...
                <p>Attention! Sont exclus des résultats la plupart des circuits d'autobus qui ne sont en opération que dans la direction du pointe, c'est-à-dire de la banlieue vers le centre-ville le matin, et vice-versa, ainsi que les circuits locaux.</p>
