    ...
    return (
        <div>
            <section>
                ...
                <p>Pour sortir de la région métropolitaine, la situation s'est grandement améliorée au fil des années. Parmi les dix secteurs du territoire desservi par exo, le transporteur qui opère les trains et les autobus dans la banlieue de Montréal, <ExternalLink href="https://exo.quebec/fr/planifier-trajet/velo/velo-a-bord">neuf en offrent la possibilité (partielle ou totale)</ExternalLink> de transporter son vélo à bord des bus, avec des heures et des dates d'utilisation harmonisées depuis quelques années. Jusqu'à deux vélos peuvent être placés <ExternalLink href="https://exo.quebec/Media/Default/pdf/section4/velo-bus/Instructions_velobus.pdf">sur le support situé à l'avant (PDF)</ExternalLink>. Il faut s'assurer de bien placer le bras d'appui le plus près de la fourche possible.</p>
                <p>Pour ce qui est du train de banlieue, il n'y a pas de restrictions à l'heure de pointe, ni de limites sur le nombre de vélos acceptés par train. Notez par contre que l'accès aux voitures de train est ardu en raison des marches à pic et de l'étroitesse des portes. Par contre, de nouvelles voitures plus accessibles circulent sur certains départs de la ligne Saint-Jérôme.</p>
                <p><ExternalLink href="https://www.stm.info/fr/velo/bienvenue-aux-velos">Le métro de Montréal</ExternalLink>, ainsi que <ExternalLink href="https://rem.info/fr/se-deplacer/faq-sur-les-deplacements/est-ce-que-je-peux-transporter-mon-velo-dans-le-rem">le REM</ExternalLink>, avec un service bien plus fréquent que le train de banlieue, offrent la possibilité de transporter son vélo en semaine avant 7 h, entre 9 h 30 et 15 h 30, ainsi qu'en soirée après 18 h. Les vélos sont permis en tout temps les fins de semaine et les jours fériés. Durant la période estivale (fin mai à fin aout), les vélos sont autorisés en tout temps, sauf <ExternalLink href="https://www.stm.info/fr/velo/calendrier-des-restrictions-lors-devenements">lors d'évènements générant de l'achalandage</ExternalLink>.</p>
            </section>
            <section>
                <h2>Se déplacer dans les régions du Québec</h2>
                <p>Quelques transporteurs en dehors de Montréal offrent la combinaison vélo-bus sur une échelle régionale, c'est-à-dire pour des distances de quelques dizaines de kilomètres. Cette catégorie s'avère utile en voyage pour sauter par-dessus une étape particulièrement difficile comme dans le nord-est de la Gaspésie, ou bien lorsqu'on se trouve dans une situation problématique quelconque.</p>
