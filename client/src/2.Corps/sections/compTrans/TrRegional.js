    ...
    return (
        <div>
            <section>
                ...
                <p>Pour ce qui est du train de banlieue, il n'y a pas de restrictions à l'heure de pointe, ni de limites sur le nombre de vélos acceptés par train. Notez par contre que l'accès aux voitures de train est ardu en raison des marches à pic et de l'étroitesse des portes.</p>
