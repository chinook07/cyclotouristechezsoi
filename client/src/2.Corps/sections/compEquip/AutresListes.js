...
const AutresListes = () => {
    return (
        <div>
            <p>Vous n'êtes pas trop du genre « interactif » ou vous souhaitez adapter la liste à vos besoins? Pas de soucis! Vous pouvez consulter la liste dans de formats différents, la modifier et l'imprimer comme bon vous le semble.</p>
            <Vignettes>
